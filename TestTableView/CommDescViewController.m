...
@interface CommDescViewController ()

@end

@implementation CommDescViewController
...
-(void)setClinicDesc:(CommClinicIndex *)newclinicDesc
{
...
-(void)configureView
{
    if (self.clinicDesc){
        ...
        self.clinicLabel.text = self.clinicDesc.deptName;
    }
}
